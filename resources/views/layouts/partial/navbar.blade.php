            ...
            <ul class="navbar-nav my-3 my-lg-0">
              ...
              <li class="nav-item">
                <div class="dropdown">
                  ...
                  <div class="row dropdown-menu">
                    <div class="col-auto" data-dropdown-content>
                      <div class="dropdown-grid-menu"><a href="style-guide.html" class="dropdown-item fade-page">Style Guide</a><a href="plugins.html" class="dropdown-item fade-page">Plugins</a>
                      </div>
                    </div>
                  </div>
                </div>
